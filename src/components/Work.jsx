    ...
    const work = [
        {
            ...
            icon: './assets/kopi.png',
            description: 'Web Design',
            link: 'https://harlangilbran.github.io/kedai-kopi-gw/',
        },
        {
        ...
        },
        {
            ...
            icon: './assets/figmaa.png',
            description: 'UI/UX Design',
            link: 'https://github.com/harlangilbran/FIGMA-WEB.git',
        }
    ];
    return (
        <div id="work" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <p className="text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo">Welcome to my web development portfolio! Explore a collection of projects showcasing my expertise in Full-Stack Web Development.</p>
